...
# Download wsldl.exe
print('Downloading wsldl ARM64...')
exe_url = 'https://github.com/yuk7/wsldl/releases/download/23072600/wsldl_arm64.exe'
exe_filename = 'eweos_arm64.exe'
...
if not os.path.exists(exe_filename):
  ...
  with open(exe_filename, 'wb') as file:
    ...
    print('eweos_arm64.exe exsists.')


# Download the eweOS' rootfs
print('Downloading rootfs...')
xz_url = 'https://os-repo.ewe.moe/eweos-images/aarch64/eweos-aarch64-tarball-Build60.2.xz'
xz_filename = 'eweos-aarch64-tarball-Build60.2.xz'
...
xz_file_path = 'eweos-aarch64-tarball-Build60.2.xz' 
